...
To make nesting easier to read and manipulate, the UI clearly shows nested groups, color codes differentiate criteria types, and introduced a drag and drop functionality.
